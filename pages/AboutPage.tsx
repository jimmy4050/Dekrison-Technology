...
const AboutPage: React.FC = () => {
  return (
    <div className="bg-white">
      {/* Page Header */}
      <div className="bg-[#0A2342] text-white py-24 text-center">
        <AnimatedSection>
      ...
      <AnimatedSection className="py-20">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0A2342] mb-6">Our Story</h2>
      ...
      <AnimatedSection className="py-20 bg-[#F8F9FA]">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 text-center">
            <div className="p-6">
              <div className="inline-block p-4 bg-[#FFD447]/20 rounded-full mb-4">
                <Target className="h-10 w-10 text-[#FFD447]" />
              </div>
              <h3 className="text-2xl font-bold text-[#0A2342] mb-3">Our Mission</h3>
            ...
            <div className="p-6">
              ...
              <h3 className="text-2xl font-bold text-[#0A2342] mb-3">Our Vision</h3>
              <p className="text-gray-600">
            ...
            <div className="p-6">
              ...
              <h3 className="text-2xl font-bold text-[#0A2342] mb-3">Our Team</h3>
              <p className="text-gray-600">
